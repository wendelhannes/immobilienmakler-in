...
export default function ImpressumPage() {
  return (
    <div className="legal">
      ...
      <h2>Hinweis zum Maklervergleich</h2>
      <p>
        immobilienmakler-in.com ist ein unabhängiges Informations- und
        Vergleichsportal. Die dargestellten Rangfolgen beruhen auf öffentlich
        einsehbaren Google-Bewertungen und stellen keine Empfehlung oder
        Gewährleistung für die Leistungen einzelner Immobilienmakler dar. Genannte
        Unternehmens- und Markennamen sind Eigentum der jeweiligen Inhaber.
      </p>
