...
const HOME_FAQ = [
  ...
  {
    q: "Können Makler ihre Platzierung kaufen?",
    a: "Nein. Platzierungen sind nicht käuflich und unabhängig davon, ob ein Makler Dienstleistungen von uns bezieht. Die Rangfolge ergibt sich allein aus den Google-Bewertungen.",
  },
];

export const metadata = {
  title: {
    absolute: "Immobilienmakler-Vergleich: Die besten Makler in 50 Städten",
  },
  description:
    "Die bestbewerteten Immobilienmakler in 50 deutschen Städten im Vergleich – auf Basis echter Google-Bewertungen, ohne bezahlte Platzierungen. Plus Ratgeber zu Hausverkauf, Bewertung und Maklerkosten.",
          ...
          <div className="hero-inner">
            <div>
              ...
              <p className="sub">
                ...
                Basis echter Google-Bewertungen, ohne bezahlte Platzierungen.
              </p>
      ...
      <div className="main">
        ...
        <section className="city-block" id="staedte">
          ...
          <p className="intro reveal">
            ...
            Ort. <Link href="/staedte">Alle Städte im Überblick →</Link>
          </p>
        ...
        <section className="topics" id="ratgeber">
          ...
          <p className="intro reveal">
            Die wichtigsten Themen verständlich erklärt – als nationaler Überblick
            und für jede Stadt einzeln.
          </p>
        ...
        {/* ── KOMPAKTER MAKLER-BANNER (einziger B2B-Touchpoint) ── */}
